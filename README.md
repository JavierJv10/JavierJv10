...
| Proyecto | Descripción | Tecnologías |
|---|---|---|
| [🌍 Web Turística — Lillo](https://javierjv10.github.io/practicas-desarrollo-web/Web-Lillo/puebloLillo.html) | Maquetación web para la promoción turística local. Estructura semántica y diseño visual. | HTML5 · CSS3 |
| [📅 Gestor de Eventos](https://javierjv10.github.io/practicas-desarrollo-web/gestor-eventos/index.html) | App interactiva para gestionar eventos. Manipulación del DOM en tiempo real. | HTML · CSS · JS |
